...
. At this point the container should be spawned, and in a few seconds your browser should open up to `localhost:8080`. If for any reason the browser does not open, you may manually navigate to this URL [http://localhost:8080]
